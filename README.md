...
## 📌 Visão Geral
O **SPL-PM** é uma ferramenta educacional e prática para simular movimentos laterais de atacantes em uma rede modelada como grafo.  
...
- Exibir grafo e destacar o caminho encontrado.
